...
from gui.uis.columns.ui_data_source import Ui_data_source
...
class PyLeftColumn(QWidget):
    ...
    def __init__(
        ...
        # ADD PAGE data_source
        self.memu_data_source = QWidget()
        data_source = Ui_data_source()
        data_source.setupUi(self.memu_data_source)
        self.menus.menus.addWidget(self.memu_data_source)
    ...
    def setup_ui(self):
        ...
        self.title_frame.setFixedHeight(47)
