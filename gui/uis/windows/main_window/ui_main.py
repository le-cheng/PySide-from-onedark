...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.window = PyWindow(
            ...
            border_color = self.themes["app_color"]["bg_one"],
        ...
        self.left_menu_frame.setFixedWidth(left_menu_minimum + (left_menu_margin * 2))
        ...
        self.left_menu = PyLeftMenu(
            ...
            dark_one = self.themes["app_color"]["left_menu_bg"],
            dark_three = self.themes["app_color"]["left_menu_enter"],
            dark_four = self.themes["app_color"]["left_menu_enter"],
        ...
        self.left_column_frame.setStyleSheet(f"background: {self.themes['app_color']['bg_one']}")
        ...
        self.left_column = PyLeftColumn(
            ...
            dark_one = self.themes['app_color']['left_menu_bg'],
            bg_color = self.themes['app_color']['left_menu_bg'],
            btn_color = self.themes['app_color']['left_menu_bg'],
            btn_color_hover = self.themes['app_color']['left_menu_enter'],
        ...
        self.title_bar = PyTitleBar(
            ...
            logo_width = 40,
            app_parent = self.central_widget,
            logo_image = "serial_port_top_logo_200x200.svg",
            bg_color = self.themes["app_color"]["left_menu_bg"],
            div_color = self.themes["app_color"]["bg_one"],
            btn_bg_color = self.themes["app_color"]["left_menu_bg"],
            btn_bg_color_hover = self.themes["app_color"]["left_menu_enter"],
        ...
        #content_area_right_bg_frame {{
            border-radius: 8px;
            background-color: {self.themes["app_color"]["left_menu_bg"]};
        }}
        ''')
        ...
        self.credits_frame.setFixedHeight(26)
        ...
        self.credits = PyCredits(
            bg_two = self.themes["app_color"]["left_menu_bg"],
